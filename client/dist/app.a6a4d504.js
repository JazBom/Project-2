...
},{"./loginUser":"src/user/loginUser.js"}],"src/imageForm.js":[function(require,module,exports) {
"use strict";
...
var imageForm = function imageForm() {
  ...
  var artistResponse = $.ajax({
    ...
    var optionsHtml = "";
    response.forEach(function (artistEl) {
      console.log('artistEl', artistEl);
      optionsHtml += "<option value=".concat(artistEl._id, ">").concat(artistEl.name, "</option>");
  ...
  var artCategoryResponse = $.ajax({
    type: "GET",
    url: "/api/images/category/all"
  }).done(function (response) {
    console.log('response', response);
    var optionsHtml = "";
    response.forEach(function (categoryEl) {
      console.log('categoryEl', categoryEl);
      optionsHtml += "<option value=".concat(categoryEl._id, ">").concat(categoryEl.name, "</option>");
      console.log('optionsHtml:', optionsHtml);
    });
    console.log('optionsHtml:', optionsHtml);
  ...
  $(document).on("click", "#createImageObject", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); // construct body by extracting info from form
  ...
  $(document).on("click", "#editImageObject", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return $.ajax({
                type: "PATCH",
                url: "/api/images/update-image/".concat($("#imageId").val()),
                contentType: "application/json",
                data: JSON.stringify(requestBody)
              });
  ...
  $(document).on("click", "#deleteImageObject", /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              e.preventDefault(); // make a PATCH request to the server to create image

              _context3.next = 3;
              return $.ajax({
                type: "DELETE",
                // check if the #imageId needs to go anywhere!!!!!
                url: "/api/images/delete-image/".concat($("#imageId").val()),
                contentType: "application/json"
              });
...
var _imageForm = _interopRequireDefault(require("../imageForm"));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              $("body").empty(); // Append the image object form to the body allowing the user to create/update/delete images

              $("body").append((0, _imageForm.default)());
              _context.next = 13;
              break;
...
exports.default = _default;
},{"./newUser":"src/user/newUser.js","../imageForm":"src/imageForm.js"}],"src/app.js":[function(require,module,exports) {
"use strict";
...
$("body").prepend((0, _loginUser.default)()); // $("body").prepend(imageForm());
